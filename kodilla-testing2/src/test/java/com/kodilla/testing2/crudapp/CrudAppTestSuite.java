...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://gkrajewski82.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("g.krajewski82@gmail.com");
    ...
    private void deleteTaskFromCrudApp (String taskName) throws InterruptedException {
        ...
        driver.findElements(
                ...
                .forEach(theForm -> {
                    WebElement selectElement = theForm.findElement(By.xpath(".//button[4]"));
                    selectElement.click();
                });
        Thread.sleep(2000);
    }
