...
public class ShopService {
    ...
    private final Authentictor authentictor;
    private final ProductService productService;

    @Autowired
    public ShopService(Authentictor authentictor, ProductService productService) {
        this.authentictor = authentictor;
        this.productService = productService;
    }

    public Long openOrder(Long userId) {
        if (authentictor.isAuthenticated(userId)) {
